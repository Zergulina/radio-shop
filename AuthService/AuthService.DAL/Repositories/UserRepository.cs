...
internal class UserRepository : IUserRepository
    {
        ...
        {
            return await _userManager.Users.Where(x => ids.Contains(x.Id)).ToListAsync();
        }
        ...
        {
            var existIds = await _userManager.Users.Where(x => ids.Contains(x.Id)).Select(x => x.Id).ToListAsync();
